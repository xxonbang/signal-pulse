...
1. **데이터 추출**: 이미지에서 종목명, 종목코드, 현재가, 전일대비, 등락률, 이동평균선(MA), 차트 패턴, 거래량 변화율, 전일, 시가, 종가, 고가, 저가, 거래량, 대금, 시총, 외인소진율, PER, EPS, 추정PER, 추정EPS, PBR, BPS, 배당수익률, 주당배당금, 컨센서스, 목표주가, 차트, 거래량, 호가, 시세, 투자자별 매매동향을 추출
